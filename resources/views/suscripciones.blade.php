...
<div class="container mt-4">
    @if(session('success'))
        <div class="alert alert-success" style="padding: 15px; background: #d4edda; color: #155724; border-radius: 5px; border: 1px solid #c3e6cb;">
            {{ session('success') }}
        </div>
    @endif
</div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card plan-card">
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('checkout', ['plan' => 'basic']) }}" class="btn btn-lg btn-block btn-primary mt-auto">BUY</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card plan-card">
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('checkout', ['plan' => 'standard']) }}" class="btn btn-lg btn-block btn-primary mt-auto">BUY</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card plan-card">
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('checkout', ['plan' => 'premium']) }}" class="btn btn-lg btn-block btn-primary mt-auto">BUY</a>
                </div>
            </div>
        </div>
    </div>
